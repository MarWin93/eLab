...
.factory('Hub', ['$', function ($) {
	...
	function initNewConnection(options) {
		...
		if (options && options.rootPath) {
			connection = $.hubConnection(options.rootPath, { useDefaultPath: false }); //musze doprowadzic do tego.. czyli ustawic rootPath ;)
		} else {
			connection = $.hubConnection(); //tu sie wyjebuje
		}
